...
class Cl_User
{
	...
	public function fb_login( Facebook\GraphNodes\GraphUser $trimmed_data )
	{
		// escape variables for security
		$name = mysqli_real_escape_string( $this->_con, $trimmed_data['name'] );
		$email = mysqli_real_escape_string( $this->_con, $trimmed_data['email'] );
		$social_id = mysqli_real_escape_string( $this->_con, $trimmed_data['id'] );
		$picture = mysqli_real_escape_string( $this->_con, "https://graph.facebook.com/".$trimmed_data['id']."/picture" );
