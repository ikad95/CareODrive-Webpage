...
$fb = new Facebook\Facebook([
  'app_id' => '181735792196003', // Replace {app-id} with your app id
  'app_secret' => '0644890c068427a8776923f5fcb559ef',
  'default_graph_version' => 'v2.5',
  ]);

$helper = $fb->getRedirectLoginHelper();
//$params = array( 'redirect_uri' => 'http://localhost/COD/login/fb-callback.php' );
$permissions = ['email']; // Optional permissions
$loginUrl = $helper->getLoginUrl('http://localhost/COD/login/fb-callback.php', $permissions);
	...
	if( !empty( $_POST )){
		try {
			...
			if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']){
				header('Location: http://localhost/COD');
			}
		} catch (Exception $e) {
			$error = $e->getMessage();
		}
  ...
  <body>
	<div class="container">
		...
		<div class="login-form">
			...
			<h1 class="text-center">CareOdrive</h1>
			...
			<form id="login-form" method="post" class="form-signin" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<br><br>
				<a class="btn btn-default facebook" href="<?php echo htmlspecialchars($loginUrl) ?>"> <i class="fa fa-facebook modal-icons"></i> Sign In with Facebook </a>
