...
<header>
  ...
  <div>
    ...
    <input id="pac-input" class="input-lg" type="text" placeholder="Enter a location">
    <div class="container" id ="x">
    Date : 
    <input type="date" id="date" >
    Time :
    <input id="time" type="time" class="required" onkeyup="check()">
    <button class="btn-info" id="book" class="required">Book!</button>
    </div>
    <div id="map"></div>
  </div>
</div>
<script>
      ...
      google.maps.Map(document.getElementById('map'), {     center: {lat:
      22.5726, lng: 88.364},     zoom: 14   });   var input = /** @type
      {!HTMLInputElement} */( document.getElementById('pac-input'));
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAWcnGSsp39d3yPNWfKyM6iLgbdcTdk0oU&libraries=places&callback=initMap"
        async defer></script>
...
<footer>
      <div class="container clearfix">
    <div class="privacy pull-left">&copy; 2016 | CareODrive</div>
  </div>
    </footer>
